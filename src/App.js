...
function Menu() {
  return (
    <nav className='menu'>
      <NavLink exact to='/' className='menu__item' activeClassName={classNames('menu__item-active', 'menu__item')}>Главная</NavLink>
      <NavLink exact to='/drift' className='menu__item' activeClassName={classNames('menu__item-active', 'menu__item')}>Дрифт-такси</NavLink>
      <NavLink exact to='/timeAttack' className='menu__item' activeClassName={classNames('menu__item-active', 'menu__item')}>​​​​​​Time Attack</NavLink>
      <NavLink exact to='/forza' className='menu__item' activeClassName={classNames('menu__item-active', 'menu__item')}>Forza Karting</NavLink>
    </nav>
  )
}
